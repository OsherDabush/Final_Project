...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:ImageProcess_TOP:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: ImageProcess_TOP_0, and set properties
  set ImageProcess_TOP_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ImageProcess_TOP:1.0 ImageProcess_TOP_0 ]
  ...
  set threshold [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 threshold ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
   CONFIG.C_DOUT_DEFAULT {0x00000050} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net ImageProcess_TOP_0_m_axis [get_bd_intf_pins ImageProcess_TOP_0/m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins ImageProcess_TOP_0/s_axis] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net ps7_0_M_AXI_GP0 [get_bd_intf_pins ps7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph_1/S00_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_1_M01_AXI [get_bd_intf_pins ps7_0_axi_periph_1/M01_AXI] [get_bd_intf_pins system_interrupts/s_axi]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_1_M02_AXI [get_bd_intf_pins ps7_0_axi_periph_1/M02_AXI] [get_bd_intf_pins video/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_1_M03_AXI [get_bd_intf_pins ps7_0_axi_periph_1/M03_AXI] [get_bd_intf_pins threshold/S_AXI]
  ...
  connect_bd_net -net ps7_0_FCLK_CLK0 [get_bd_pins ImageProcess_TOP_0/aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins ps7_0/FCLK_CLK0] [get_bd_pins ps7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0/S_AXI_HP2_ACLK] [get_bd_pins ps7_0_axi_periph_1/ACLK] [get_bd_pins ps7_0_axi_periph_1/M00_ACLK] [get_bd_pins ps7_0_axi_periph_1/M01_ACLK] [get_bd_pins ps7_0_axi_periph_1/M02_ACLK] [get_bd_pins ps7_0_axi_periph_1/M03_ACLK] [get_bd_pins ps7_0_axi_periph_1/S00_ACLK] [get_bd_pins rst_ps7_0_fclk0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins system_interrupts/s_axi_aclk] [get_bd_pins threshold/s_axi_aclk] [get_bd_pins video/clk_100M]
  ...
  connect_bd_net -net rst_ps7_0_fclk0_interconnect_aresetn [get_bd_pins ps7_0_axi_periph_1/ARESETN] [get_bd_pins rst_ps7_0_fclk0/interconnect_aresetn] [get_bd_pins video/ic_resetn_clk100M]
  connect_bd_net -net rst_ps7_0_fclk0_peripheral_aresetn [get_bd_pins ImageProcess_TOP_0/aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph_1/M00_ARESETN] [get_bd_pins ps7_0_axi_periph_1/M01_ARESETN] [get_bd_pins ps7_0_axi_periph_1/M02_ARESETN] [get_bd_pins ps7_0_axi_periph_1/M03_ARESETN] [get_bd_pins ps7_0_axi_periph_1/S00_ARESETN] [get_bd_pins rst_ps7_0_fclk0/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins system_interrupts/s_axi_aresetn] [get_bd_pins threshold/s_axi_aresetn] [get_bd_pins video/periph_resetn_clk100M]
  ...
  connect_bd_net -net threshold_gpio_io_o [get_bd_pins ImageProcess_TOP_0/threshold] [get_bd_pins threshold/gpio_io_o]
  ...
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs threshold/S_AXI/Reg] -force
